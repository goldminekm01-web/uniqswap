...
export function SwapCard() {
  ...
  const handleSwap = async () => {
    ...
    // Transaction flow: signing → pending → success/failed
    setTxStatus("signing");
    setTxError(null);
    ...
    <div className="w-full" id="swap">
      <div className={cardClass}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative flex-shrink-0" ref={tokenSelectorRef}>
            <button
            ...
            {/* Dropdown for selecting from-token */}
            {tokenSelectorOpen && fromToken !== KSH_TOKEN_KEY && (
              <div className="absolute top-full left-0 z-10 mt-1 w-48 rounded-xl border border-white/10 bg-dark-900/90 backdrop-blur-xl shadow-xl">
        ...
        {txStatus !== "idle" && (
          <div className="mb-3 rounded-lg border border-white/5 bg-dark-900/40 p-3 text-center">
            ...
            {txStatus === "pending" && (
              <p className="text-sm text-brand-accent">
                Transaction pending on the blockchain…
              </p>
            )}
